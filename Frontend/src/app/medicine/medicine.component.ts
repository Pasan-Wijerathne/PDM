...
export class MedicineComponent implements OnInit {
  ...
  constructor(private consume : MedicineserviceService) { }
  ...
  adduser()
  {
      ...
      var ebill = {"illness":"","description":"","userid":"uid","date":"","totalamount":""};
  ...
  saveUser(e){
    ...
    // this.consume.createacc(this.values);
     ...
     this.consume.createmedicine<any[]>(this.values).subscribe((data : any[])  => this.values = data, error => () => 
     {
        console.log(error);
     },() =>
     {
